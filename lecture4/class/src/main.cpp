...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        if (!armors.empty())
        {
            ...
            std::vector<cv::Point2f> img_points{armor.left.top, armor.left.bottom, armor.right.bottom, armor.right.top};
            ...
            auto yaw = atan2(rmat.at<double>(0, 2), rmat.at<double>(2, 2));
            auto pitch = -asin(rmat.at<double>(1, 2));
            auto roll = atan2(rmat.at<double>(1, 0), rmat.at<double>(1, 1));
